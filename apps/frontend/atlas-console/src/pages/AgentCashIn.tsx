...
export default function AgentCashIn() {
  ...
  const cashInMutation = useMutation({
    mutationFn: async () => {
      ...
      return AgentService.cashInIntent(user.msisdn, agentCode, amountMinor, 'NGN');
    },
    onSuccess: (data) => {
      toast.success("Cash-in request sent to agent");
      setAmount("");
    },
    onError: (error: any) => {
      if (error instanceof AtlasApiError) {
        ...
        toast.error(error.message || "Failed to create cash-in intent");
      }
    },
  });
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <Button 
              ...
              className="w-full" 
              size="lg"
              disabled={cashInMutation.isPending || !agentCode || !amount}
            >
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <ol className="text-sm text-muted-foreground space-y-1">
              ...
              <li>2. Agent receives cash-in request</li>
              <li>3. Deposit cash with agent</li>
              <li>4. Agent confirms deposit</li>
              <li>5. Funds credited to your account</li>
            </ol>
          </CardContent>
        </Card>
      </div>
